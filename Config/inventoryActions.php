...
class inventoryActions extends Actions{
    protected $permissions = array(
        "inventory_public" => array(
            "nome"      => "inventory_public",
            "label"     => "Acesso ao inventory",
            "descricao" => "Acesso público ao plugin inventory",
            "default"   => "n",
        ),
         "inventory_admin" => array(
            "nome"      => "inventory_admin",
    ...
    protected $actions = array( 
        "inventory/index/index" => array(
            ...
            "menu" => array('inventory/technical/index'),
            "breadscrumb" => array("inventory/index/index", )
        ),
        
        'inventory/technical/index' => array(
            'label' => 'Home Técnico', 'publico' => 'n', 'default_yes' => 's','default_no' => 'n',
            'permission' => 'inventory_public',
            "breadscrumb" => array("inventory/technical/index")
        ),
        
        'inventory/technical/newvisit' => array(
            'label' => 'Nova Visita', 'publico' => 'n', 'default_yes' => 's','default_no' => 'n',
            'permission' => 'inventory_public',
            "breadscrumb" => array("inventory/technical/index","inventory/technical/newvisit")
        ),
        'inventory/technical/visits' => array(
            'label' => 'Visitas do Técnico', 'publico' => 'n', 'default_yes' => 's','default_no' => 'n',
            'permission' => 'inventory_public',
            "breadscrumb" => array("inventory/technical/index","inventory/technical/visits")
        ),
        'inventory/technical/visitdetail' => array(
            'label' => 'Detalhes da Visita', 'publico' => 'n', 'default_yes' => 's','default_no' => 'n',
            'permission' => 'inventory_public',
            "breadscrumb" => array("inventory/technical/index","inventory/technical/visits","inventory/technical/visitdetail")
        ),
        'inventory/technical/mystock' => array(
            'label' => 'Estoque do Técnico', 'publico' => 'n', 'default_yes' => 's','default_no' => 'n',
            'permission' => 'inventory_public',
            "breadscrumb" => array("inventory/technical/index","inventory/technical/mystock")
        ),
        'inventory/technical/movement' => array(
            'label' => 'Movimentações do produto', 'publico' => 'n', 'default_yes' => 's','default_no' => 'n',
            'permission' => 'inventory_public',
            "breadscrumb" => array("inventory/technical/index","inventory/technical/movement")
        ),
        'inventory/technical/movdetail' => array(
            'label' => "Detalhes da movimentação", 'publico' => 'n', 'default_yes' => 's','default_no' => 'n',
            'permission' => 'inventory_public',
            "breadscrumb" => array("inventory/technical/index","inventory/technical/movement","inventory/technical/movdetail")
        ),
        ...
        'inventory/stock/show' => array(
            ...
            'permission' => 'inventory_admin', 'needcod' => true,
